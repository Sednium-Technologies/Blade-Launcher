...
import com.sednium.bladelauncher.game.path.GamePathManager
import com.sednium.bladelauncher.game.version.installed.Version
import com.sednium.bladelauncher.game.version.installed.VersionComparator
import com.sednium.bladelauncher.game.version.installed.VersionType
import com.sednium.bladelauncher.game.version.installed.VersionsManager
import com.sednium.bladelauncher.game.version.installed.cleanup.GameAssetCleaner
import com.sednium.bladelauncher.ui.activities.MainActivity
...
import com.sednium.bladelauncher.ui.screens.content.elements.CleanupOperation
import com.sednium.bladelauncher.ui.screens.content.elements.GamePathItemLayout
import com.sednium.bladelauncher.ui.screens.content.elements.GamePathOperation
import com.sednium.bladelauncher.ui.screens.content.elements.VersionCategory
import com.sednium.bladelauncher.ui.screens.content.elements.VersionCategoryItem
import com.sednium.bladelauncher.ui.screens.content.elements.VersionItemLayout
import com.sednium.bladelauncher.ui.screens.content.elements.VersionsOperation
import com.sednium.bladelauncher.utils.animation.swapAnimateDpAsState
import com.sednium.bladelauncher.utils.canHandlePermission
import com.sednium.bladelauncher.utils.checkStoragePermissions
...
fun VersionsManageScreen(
    ...
    BaseScreen(
        ...
        BoxWithConstraints(modifier = Modifier.fillMaxSize()) {
            ...
            var showGamePathsSheet by remember { mutableStateOf(false) }
            ...
            if (isCompact) {
                VersionsLayout(
                    ...
                    onOpenGamePaths = {
                        showGamePathsSheet = true
                    }
                )

                if (showGamePathsSheet) {
                    val sheetState = rememberModalBottomSheetState(skipPartiallyExpanded = true)
                    ModalBottomSheet(
                        onDismissRequest = { showGamePathsSheet = false },
            ...
            Column(modifier = Modifier.fillMaxSize()) {
                CardTitleLayout {
                    ...
                    Row(
                        ...
                        if (onOpenGamePaths != null) {
                            IconTextButton(
                                onClick = onOpenGamePaths,
                                painter = painterResource(R.drawable.ic_folder_outlined),
                                contentDescription = stringResource(R.string.versions_manage_game_path),
                                text = stringResource(R.string.versions_manage_game_path)
                            )
                        }
                        IconTextButton(
                            onClick = onRefresh,
