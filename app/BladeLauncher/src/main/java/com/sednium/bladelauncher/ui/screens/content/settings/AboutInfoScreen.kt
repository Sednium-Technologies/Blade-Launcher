...
import com.sednium.bladelauncher.game.plugin.PluginLoader
import com.sednium.bladelauncher.game.plugin.appCacheIcon
import com.sednium.bladelauncher.library.LibraryInfo
import com.sednium.bladelauncher.library.libraryData
import com.sednium.bladelauncher.path.URL_BLADE_PROJECT
import com.sednium.bladelauncher.path.URL_COMMUNITY
import com.sednium.bladelauncher.path.URL_MCMOD
import com.sednium.bladelauncher.path.URL_PROJECT
import com.sednium.bladelauncher.path.URL_SUPPORT
import com.sednium.bladelauncher.path.URL_WEBLATE
                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                        ...
                        ButtonIconItem(
                            ...
                            button = {
                                ...
                                Button(
                                    onClick = { openLink(URL_BLADE_PROJECT) }
                                ) {
                                ...
                                Button(
                                    ...
                                    Text(text = stringResource(R.string.about_launcher_gplv3_license))
                                }
                            }
                        )
                        ...
                        ButtonIconItem(
                            icon = painterResource(R.drawable.img_launcher),
                            title = stringResource(R.string.about_team_sednium_title),
                            text = stringResource(R.string.about_team_sednium_text),
                            button = {
                                Button(
                                    onClick = { openLink(URL_BLADE_PROJECT) }
                                ) {
                        ...
                        // Upstream Original Author (MovTery)
                        ButtonIconItem(
                            ...
                            button = {
                                ...
                                Button(
                                    ...
                                    Text(text = stringResource(R.string.about_launcher_upstream_link))
                                }
                            }
                        )
                    }
...
private fun LinkIconItem(
    ...
    Surface(
        ...
        Column(
            ...
            if (openLicense != null || openLink != null) {
                Row(
                    modifier = Modifier.fillMaxWidth(),
