...
import com.sednium.bladelauncher.game.download.game.GameDownloadInfo
import com.sednium.bladelauncher.game.download.game.GameInstaller
import com.sednium.bladelauncher.game.download.game.optifine.CantFetchingOptiFineUrlException
import com.sednium.bladelauncher.game.download.jvm_server.JvmCrashException
import com.sednium.bladelauncher.game.version.download.DownloadFailedException
...
import com.sednium.bladelauncher.notification.NotificationManager
...
import com.sednium.bladelauncher.ui.components.NotificationCheck
import com.sednium.bladelauncher.ui.components.fadeEdge
import com.sednium.bladelauncher.ui.components.verticalScrollWithBar
...
import com.sednium.bladelauncher.ui.screens.content.elements.TitleTaskFlowDialog
import com.sednium.bladelauncher.ui.screens.content.versions.AddonDiffs
import com.sednium.bladelauncher.ui.screens.content.versions.ModsManagerScreen
import com.sednium.bladelauncher.ui.screens.content.versions.ResourcePackManageScreen
import com.sednium.bladelauncher.ui.screens.content.versions.SavesManagerScreen
import com.sednium.bladelauncher.ui.screens.content.versions.ScreenshotsManagerScreen
import com.sednium.bladelauncher.ui.screens.content.versions.ServerListScreen
import com.sednium.bladelauncher.ui.screens.content.versions.ShadersManagerScreen
import com.sednium.bladelauncher.ui.screens.content.versions.UpdateLoaderScreen
import com.sednium.bladelauncher.ui.screens.content.versions.VersionConfigScreen
import com.sednium.bladelauncher.ui.screens.content.versions.VersionOverViewScreen
...
import com.sednium.bladelauncher.ui.theme.showThemed
...
fun VersionSettingsScreen(
    ...
    BaseScreen(
        ...
        val items = remember(canUpdateLoader, isUpdateLoader) {
            val list = mutableListOf(
                ...
                CategoryItem(NormalNavKey.Versions.ModsManager, { CategoryIcon(R.drawable.ic_extension_outlined, R.string.mods_manage) }, R.string.mods_manage),
            ...
            if (canUpdateLoader) {
                val textRes = if (isUpdateLoader) R.string.versions_update_loader else R.string.versions_install_loader
                list.add(
                    CategoryItem(NormalNavKey.Versions.UpdateLoader, { CategoryIcon(R.drawable.ic_update, textRes) }, textRes)
                )
            }
            list.add(CategoryItem(NormalNavKey.Versions.ResourcePackManager, { CategoryIcon(R.drawable.ic_format_paint_outlined, R.string.resource_pack_manage) }, R.string.resource_pack_manage))
            list.add(CategoryItem(NormalNavKey.Versions.ShadersManager, { CategoryIcon(R.drawable.ic_lightbulb, R.string.shader_pack_manage) }, R.string.shader_pack_manage))
            list.add(CategoryItem(NormalNavKey.Versions.ScreenshotsManager, { CategoryIcon(R.drawable.ic_photo_library_outlined, R.string.screenshots_manage) }, R.string.screenshots_manage))
            list.add(CategoryItem(NormalNavKey.Versions.ServerList, { CategoryIcon(R.drawable.ic_dns_outlined, R.string.servers_list) }, R.string.servers_list))
            list
        }
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            AppBottomNavigationBar(
                ...
                onNavigate = { itemKey ->
                    if (itemKey == NormalNavKey.Versions.UpdateLoader) {
                        if (isUpdateLoader) {
