...
Java_com_sednium_bladelauncher_utils_device_VulkanChecker_nativeSetLogCallback(
        JNIEnv *env,
        jclass clazz,
        jobject callback
) {
...
Java_com_sednium_bladelauncher_utils_device_VulkanChecker_nativeCheckVulkan(
        JNIEnv *env,
        jclass clazz,
        jstring jDriverPath,
        jstring jNativeDir,
    ...
    VkApplicationInfo appInfo = {
            ...
            .pApplicationName = "BladeLauncher",
...
#undef PUT_FEAT
    ...
    jclass capClass = (*env)->FindClass(env, "com/sednium/bladelauncher/utils/device/VulkanCapabilities");
