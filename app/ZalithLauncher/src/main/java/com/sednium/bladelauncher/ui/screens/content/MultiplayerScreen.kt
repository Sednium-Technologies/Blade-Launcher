...
import com.sednium.bladelauncher.path.URL_EASYTIER
                ...
                Column(
                    ...
                    SecondaryTabRow(
                        ...
                        Tab(
                            ...
                            onClick = { mobileTab = 0 },
                            text = { Text(stringResource(R.string.terracotta_menu)) }
                        )
                        Tab(
                            selected = mobileTab == 1,
                            onClick = { mobileTab = 1 },
                            text = { Text(stringResource(R.string.terracotta_confirm_title)) }
                        )
                    }
